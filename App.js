...
class MainActivity extends Component{
  ...
  InsertStudentRecordsToServer = () =>{
    ...
    fetch('http://221a4b2c.ngrok.io/reactwebapp/InsertStudentData.php',{
      method: 'POST',
      headers: {
  ...
  }//end GoTo_Show_StudentList_Activity_Function
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
    ...
    return fetch('http://221a4b2c.ngrok.io/reactwebapp/ShowAllStudentsList.php')
      .then((response) => response.json())
      .then((responseJson) => {
...
}// end class ShowStudentListActivity
...
class EditStudentRecordActivity extends Component {
  ...
  UpdateStudentRecord = () => {
    ...
    fetch('http://221a4b2c.ngrok.io/reactwebapp/UpdateStudentRecord.php', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  DeleteStudentRecord = () => {
    ...
    fetch('http://221a4b2c.ngrok.io/reactwebapp/DeleteStudentRecord.php', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
}//end class EditStudentRecordActivity
